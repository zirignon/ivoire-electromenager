...
// Traiter la commande et l'envoyer sur WhatsApp
async function processCheckout(e) {
    ...
    try {
        ...
        // Utiliser l'identifiant réel Supabase.
        orderId = savedOrder.id;
        order.id = savedOrder.id;

        // Garder aussi une copie locale pour compatibilité avec ton admin actuel.
        saveOrder(order);
    } catch (error) {
    ...
    // Préparer la liste des articles pour WhatsApp.
...
`.trim();
    ...
    // Vider le panier après l'enregistrement et l'envoi vers WhatsApp.
    cart = [];
    saveCart();
    updateCartUI();
    closeCheckout();
